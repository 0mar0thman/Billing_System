...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        ...
        <a class="desktop-logo logo-dark active" href="{{ url('/' . ($page = 'index')) }}"><img
                src="{{ URL::asset('assets/img/brand/favicon-white.png') }}" class="main-logo dark-theme"
                alt="logo"></a>
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('Invoice_UnPaid')}}">الفواتير الغير مدفوعة</a>
                    </li>
                    <li><a class="slide-item" href="{{ route('Invoice_Partial')}}">الفواتير المدفوعة جزئيا</a>
                    </li>
                    <li><a class="slide-item" href="{{ route('Archive.index') }}">ارشيف الفواتير</a></li>
                    <li><a class="slide-item" href="{{ route('invoices.sitting') }}">اعدادات الفواتير</a></li>
                </ul>
            </li>
            {{-- <li class="slide">
